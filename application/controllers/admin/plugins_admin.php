		...
		switch ($action)
		{
			case 'enable':
				...
				if ($plugin === FALSE)
				{
					...
					flash_notice('error', _('The plugin couldn\'t be enabled.'));
				}
				else
				{
					flash_notice('success',
						sprintf(_('The %s plugin is now enabled.'), $plugin->info->name));
				}
				break;
			...
			case 'disable':
				...
				if ($plugin === FALSE)
				{
					...
					flash_notice('error', _('The plugin couldn\'t be disabled.'));
				}
				else
				{
					flash_notice('success',
						sprintf(_('The %s plugin is now disabled.'), $plugin->info->name));
				}
				break;
			...
			case 'remove':
				...
				if (isset($result['error']))
				{
					...
					flash_notice('error',
						sprintf(_('The %splugin couldn\'t be removed.'), $plugin->info->name));
				}
				else
				{
					flash_notice('success',
						sprintf(_('The %s plugin was removed.'), $plugin->info->name));
				}
				break;
		}
