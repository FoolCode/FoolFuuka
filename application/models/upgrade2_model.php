...
class Upgrade2_model extends CI_Model {
	...
	function do_upgrade() {
		...
		$this->db->update('preferences', array('value' => 'fs_priv_maintenance'), array('name' => __("We're currently upgrading FoOlSlide. This process usually takes few seconds or a couple minutes, check back soon!")));
