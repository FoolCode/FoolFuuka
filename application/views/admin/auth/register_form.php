<div class="well">
	...
	<?php echo form_open(); ?>
	<?php if ($use_username) : ?>
		<label><?php echo form_label(__('Username'),
		$username['id']); ?></label>
	...
	<label><?php echo form_label(__('Email Address'),
		$email['id']); ?></label>
