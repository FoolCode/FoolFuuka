...
$info['slug'] = 'FU_Patch_SOPA_Spoilers_2012';
// name under which to display your plugin
$info['name'] = 'Patch SOPA Spoilers 2012';
// short description about what the plugin does
$info['description'] = __('Prevents the display of the spoilers used by 4chan during the SOPA protest.');
