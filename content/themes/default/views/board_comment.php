...
<article class="post doc_id_<?= $p->doc_id ?>
	...
	<header>
		<div class="post_data">
			...
			<?php if ($p->deleted == 1) : ?><span class="post_type"><img src="<?= site_url().'content/themes/'.($this->theme->get_selected_theme() ? $this->theme->get_selected_theme() : 'default').'/images/icons/file-delete-icon.png'; ?>" width="16" height="16" title="<?= form_prep(__('This post was deleted from 4chan manually.')) ?>"/></span><?php endif ?>
			<?php if ($p->spoiler == 1) : ?><span class="post_type"><img src="<?= site_url().'content/themes/'.($this->theme->get_selected_theme() ? $this->theme->get_selected_theme() : 'default').'/images/icons/spoiler-icon.png'; ?>" width="16" height="16" title="<?= form_prep(__('This post contains a spoiler image.')) ?>"/></span><?php endif ?>
			<?php if ($p->subnum > 0)   : ?><span class="post_type"><img src="<?= site_url().'content/themes/'.($this->theme->get_selected_theme() ? $this->theme->get_selected_theme() : 'default').'/images/icons/communicate-icon.png'; ?>" width="16" height="16" title="<?= form_prep(__('This post was made in the archive.')) ?>"/></span><?php endif ?>
		</div>
	</header>
