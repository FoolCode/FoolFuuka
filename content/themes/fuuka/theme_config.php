...
$config['theme_directory'] = 'fuuka';
$config['theme_name'] = 'Fuuka';
$config['theme_description'] = 'The Fuuka archiver theme';
$config['theme_tags'] = array('Fuuka', 'archive');
...
$config['theme_extends'] = 'fuuka'; // it's ok to refer it to itself, it means there's no fallback
