		...
		<footer id="footer">
			...
			<div style="float:right">
				<div class="btn-group dropup pull-right">
					...
					<ul class="dropdown-menu">
						<?php
						foreach($this->theme->get_available_styles('yotsuba_2') as $key => $style) :
						?>
							<li>
								<a href="<?= site_url(array('@system', 'functions', 'theme', $this->get_selected_theme(), $style)) ?>">
									<?= $key ?><?= ($style == $this->theme->get_selected_theme_class()) ?' <i class="icon-ok"></i>':'' ?>
								</a>
							</li>
						<?php endforeach; ?>
					</ul>
