...
?><!DOCTYPE html>
    ...
    <head>
		...
		<?php endif; ?>
        <link href="<?= \Uri::base().'assets/bootstrap2/css/bootstrap.min.css?v=' ?>" rel="stylesheet" type="text/css" />
        <link href="<?= \Uri::base().'assets/font-awesome/css/font-awesome.css?v=' ?>" rel="stylesheet" type="text/css" />
        <!--[if lt IE 8]>
		<link href="<?= \Uri::base().'assets/font-awesome/css/font-awesome-ie7.css?v=' ?>" rel="stylesheet" type="text/css" />
        <![endif]-->
	    <?php
		...
		?>
        <link href="<?= $this->getBuilder()->getTheme()->getAssetManager()->getAssetLink('style.css') ?>" rel="stylesheet" type="text/css" />
        <!--[if lt IE 9]>
    ...
    <script>
        var backend_vars = <?= json_encode($this->getBuilder()->getParamManager()->getParam('backend_vars')) ?>;
    </script>
    ...
    <script defer src="<?= $this->getBuilder()->getTheme()->getAssetManager()->getAssetLink('plugins.js') ?>"></script>
    <script defer src="<?= $this->getBuilder()->getTheme()->getAssetManager()->getAssetLink('board.js') ?>"></script>
